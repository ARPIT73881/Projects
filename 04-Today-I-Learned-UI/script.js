...
async function loadFacts() {
  const res = await fetch(
    "https://ynpaenrbxqrhexebrixm.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlucGFlbnJieHFyaGV4ZWJyaXhtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjIwOTM4MDIsImV4cCI6MjAzNzY2OTgwMn0.sXlt02RYR3zxPZNkCT4OK_DovTUmt61imKaaLrLYpos",
      },
    }
  );
